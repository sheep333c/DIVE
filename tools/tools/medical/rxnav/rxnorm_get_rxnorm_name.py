"""
Tool for getting Rxnorm names for drug concepts.

This tool retrieves the Rxnorm name for a given RxCUI.
"""
...
class RxnormGetRxnormNameTool(Tool):
    """
    Tool for getting Rxnorm names for drug concepts.
    
    Description:
        Retrieve the Rxnorm name for a given RxCUI using the RxNAV REST API.
        Returns the preferred name/term for drug concepts.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Get Rxnorm name for a drug concept."""
        try:
            # 构建URL - rxcui在路径中，其他参数作为查询参数
            rxcui = params.get("rxcui", "")
            base_url = f"https://rxnav.nlm.nih.gov/REST/rxcui/{rxcui}.json"
