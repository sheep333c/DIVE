"""
Tool for getting Rxnorm concept properties for prescribable drug concepts.
...
class PrescribableGetRxConceptPropertiesTool(Tool):
    """
    Tool for getting Rxnorm concept properties for prescribable drug concepts.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Get Rxnorm concept properties for a prescribable drug concept."""
        try:
            # 构建URL - rxcui在路径中，其他参数作为查询参数
            rxcui = params.get("rxcui", "")
            base_url = f"https://rxnav.nlm.nih.gov/REST/Prescribe/rxcui/{rxcui}/properties.json"
