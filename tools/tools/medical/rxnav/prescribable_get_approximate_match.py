"""
Tool for getting approximate match information for prescribable concepts.
...
class PrescribableGetApproximateMatchTool(Tool):
    """
    Tool for getting approximate match information for prescribable concepts.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Get approximate match information for prescribable concepts."""
        try:
            # 构建URL和查询参数
            base_url = "https://rxnav.nlm.nih.gov/REST/Prescribe/approximateTerm.json"
