"""
Clinical Tables API - ICD-10-CM诊断代码搜索

提供对ICD-10-CM（国际疾病分类第10版，临床修订版）诊断代码的搜索功能。
"""
...
class Icd10cmDiagnosisCodesTool(Tool):
    """
    Tool for searching ICD-10-CM diagnosis codes.
    
    Description:
        Search ICD-10-CM (International Classification of Diseases, 10th Revision, Clinical Modification) 
        diagnosis codes maintained by the Centers for Disease Control and Prevention (CDC).
    ...
    Output Format:
        ...
        - Success: JSON array containing ICD-10-CM diagnosis code data
