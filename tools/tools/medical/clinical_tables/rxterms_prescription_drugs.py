"""
Clinical Tables API - Rxterms处方药搜索

提供对Rxterms处方药数据的搜索功能，支持药物名称和成分查询。
"""
...
class RxtermsPrescriptionDrugsTool(Tool):
    """
    Tool for searching Rxterms prescription drugs.
    
    Description:
        Search Rxterms prescription drug data including drug names, ingredients, 
        and related pharmaceutical information for clinical decision support.
    
    Input Parameters:
        - terms (str, required): Search keywords for drug names or ingredients
    ...
    Output Format:
        ...
        - Success: JSON array containing Rxterms prescription drug data
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Search Rxterms prescription drugs."""
        try:
            # 构建URL - 直接使用所有参数
