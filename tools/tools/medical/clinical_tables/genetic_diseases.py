"""
Clinical Tables API - 遗传疾病搜索

提供对遗传疾病数据的搜索功能，支持疾病名称和相关基因信息查询。
"""
...
class GeneticDiseasesTool(Tool):
    """
    Tool for searching genetic diseases.
    
    Description:
        Search genetic disease information including disease names, associated genes,
        inheritance patterns, and clinical characteristics for medical research.
    
    Input Parameters:
        - terms (str, required): Search keywords for disease names or gene symbols
    ...
    Output Format:
        ...
        - Success: JSON array containing genetic disease data
