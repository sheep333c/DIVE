"""
Tool for retrieving papers by a specific author from Semantic Scholar.

Get all papers published by a specific author with pagination.
"""
...
class SemanticScholarAuthorPapersTool(Tool):
    """
    Tool for retrieving papers by a specific author from Semantic Scholar.
    
    Description:
        Get all papers published by a specific author with pagination.
        Supports field selection and sorting options.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Get author papers using Semantic Scholar API."""
        import time
