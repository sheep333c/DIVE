"""
Tool for retrieving authors of a specific paper from Semantic Scholar.

Get all authors of a specific paper with pagination.
"""
...
class SemanticScholarPaperAuthorsTool(Tool):
    """
    Tool for retrieving authors of a specific paper from Semantic Scholar.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Get paper authors using Semantic Scholar API."""
        import time
