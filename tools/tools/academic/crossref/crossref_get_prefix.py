"""
Tool for retrieving DOI prefix metadata.

Get detailed metadata for a DOI owner prefix.
"""
...
class CrossrefGetPrefixTool(Tool):
    """
    Tool for retrieving DOI prefix metadata.
    ...
    Input Parameters:
        - prefix (str, required): Parameter description
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Execute crossref_get_prefix request."""
        import time
        ...
        base_url = f"https://api.crossref.org/prefixes/{prefix}"
        query_params = {k: v for k, v in params.items() if k != "prefix" and v is not None}
