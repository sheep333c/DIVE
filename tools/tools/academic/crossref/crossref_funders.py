"""
Tool for retrieving funders from the Funder Registry.

Returns list of funders with location filtering, query, and pagination support.
"""
...
class CrossrefFundersTool(Tool):
    """
    Tool for retrieving funders from the Funder Registry.
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Execute crossref_funders request."""
        import time
