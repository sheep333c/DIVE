"""
Tool for retrieving valid work types list.

Returns list of valid work types with pagination support.
"""
...
class CrossrefTypesTool(Tool):
    ...
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """Execute crossref_types request."""
        import time
        
        base_url = "https://api.crossref.org/types"
