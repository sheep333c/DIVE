"""
Simple global pairwise sequence alignment tool using Bio.Align.PairwiseAligner.

This tool performs global pairwise sequence alignment with default parameters.
"""
...
class Pairwise2GlobalXXTool(Tool):
    """
    Tool for performing simple global pairwise sequence alignment.
    
    Uses Bio.Align.PairwiseAligner for global alignment with default parameters
    (match=1, mismatch=0, no gap penalties).
    """
    
    def execute(self, context: ExecutionContext, params: Dict[str, Any]) -> Dict[str, Any]:
        """
        Perform simple global pairwise sequence alignment.
