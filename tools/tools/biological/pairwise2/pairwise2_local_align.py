"""
Local pairwise sequence alignment tool using Bio.Align.PairwiseAligner.

This tool performs local pairwise sequence alignment with customizable scoring parameters.
"""
...
class Pairwise2LocalAlignTool(Tool):
    """
    Tool for performing local pairwise sequence alignment.
    
    Uses Bio.Align.PairwiseAligner for local alignment with customizable
